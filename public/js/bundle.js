...
var hideAlert = function hideAlert() {
  var remove = document.querySelector('.alert');
...
var showAlert = function showAlert(status, message) {
  ...
  hideAlert();
  var markup = "<div class=\"alert alert--".concat(status, "\">").concat(message, "</div>");
        ...
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (signup.data.status.toLowerCase() === 'success') {
              (0, _alert.showAlert)('success', 'Your account has been created');
              window.setTimeout(function () {
                location.assign('/');
              }, 1500);
            }
...
exports.displaymapBox = void 0;

var displaymapBox = function displaymapBox(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoic3JpZGhhcnJhZ2h1bmF0aGFuIiwiYSI6ImNrZTM0Z3NlODBmdWQzMWxlYzF1dDdnbDkifQ.EIeqHa_cgVhufWciWcYSpA';
...
exports.displaymapBox = displaymapBox;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            url = type === 'password' ? '/api/v1/users/updateMyPassword' : '/api/v1/users/updateMydetails';
            _context.next = 4;
            return (0, _axios.default)({
              method: 'PATCH',
              url: url,
...
var stripe = Stripe('pk_test_51HJLaMCpYgCveY557qIZDzvprfm0s16v5iGWuELbFKK54muPd7L9tBjVhxAXkg7T5evlPZ35SkjwxrVOzlUenuDT00wRJH038N');

var checkoutSession = /*#__PURE__*/function () {
...
var userSaveForm = document.querySelector('.form-user-data');
var passwordForm = document.querySelector('.form-user-settings');
var booking = document.getElementById('book-tour');
var alertMessage = document.querySelector('body').dataset.alert; // there is propert in html called data it store something there we can retrieve from there

if (mapBox) {
  var locations = JSON.parse(mapBox.dataset.locations);
  (0, _mapbox.displaymapBox)(locations);
}
...
if (userSaveForm) {
  userSaveForm.addEventListener('submit', function (event) {
    event.preventDefault();
    ...
    (0, _updateSetting.updateSetting)(formInput, 'data');
  });
}
      ...
      return regeneratorRuntime.wrap(function _callee$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              event.preventDefault();
              document.querySelector('.btn--passwordUpdate').textContent = 'Updating.....';
            ...
            case 7:
              document.querySelector('.btn--passwordUpdate').textContent = 'SAVE PASSWORD';
...
if (logoutClick) {
  logoutClick.addEventListener('click', _login.logout);
}
